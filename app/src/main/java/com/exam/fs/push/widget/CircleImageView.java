...
import com.exam.fs.push.widget.internal.FastBlur;
import com.exam.fs.push.widget.internal.RSBlur;
...
public class CircleImageView extends ImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.baselib_CircleImageView, defStyleAttr, 0);
        try {
            int ct = a.getInteger(R.styleable.baselib_CircleImageView_baselib_corner_type, 0);
            cornerType = getCornerType(ct);
            
            int ot = a.getInteger(R.styleable.baselib_CircleImageView_baselib_other_type, 0);
            otherType = getOtherType(ot);
            
            cornerRadius = a.getDimension(R.styleable.baselib_CircleImageView_baselib_corner_radius, 0);
            blurRadius = a.getFloat(R.styleable.baselib_CircleImageView_baselib_blur_radius, 0);
            
            borderWidth = a.getDimension(R.styleable.baselib_CircleImageView_baselib_border_width, 0);
            borderColor = a.getColor(R.styleable.baselib_CircleImageView_baselib_border_color, 0);
            defaultColor = a.getColor(R.styleable.baselib_CircleImageView_baselib_default_color, 0);
            
            isCircle = a.getBoolean(R.styleable.baselib_CircleImageView_baselib_is_circle, false);
            hasBorder = a.getBoolean(R.styleable.baselib_CircleImageView_baselib_has_border, false);
            isBlur = a.getBoolean(R.styleable.baselib_CircleImageView_baselib_is_blur, false);
            isOval = a.getBoolean(R.styleable.baselib_CircleImageView_baselib_is_oval, false);
        } finally {
            a.recycle();
        }
    }
...
//                    canvas.drawPath(path, mPaintBorder);
    ...
    //set get==================================================================
    public CircleImageView setCornerRadius(float cornerRadius) {
        this.cornerRadius = cornerRadius;
        return this;
    }
    
    public CircleImageView setBorderWidth(float borderWidth) {
        this.borderWidth = borderWidth;
        return this;
    }
    
    public CircleImageView setBorderColor(@ColorInt int borderColor) {
        this.borderColor = borderColor;
        return this;
    }
    
    public CircleImageView setDefaultColor(@ColorInt int defaultColor) {
        this.defaultColor = defaultColor;
        return this;
    }
    
    public CircleImageView setCircle(boolean circle) {
        isCircle = circle;
        return this;
    }
    
    public CircleImageView setHasBorder(boolean hasBorder) {
        this.hasBorder = hasBorder;
        return this;
    }
    
    public CircleImageView setBlur(boolean blur) {
        isBlur = blur;
        return this;
    }
    
    public CircleImageView setBlurRadius(float blurRadius) {
        this.blurRadius = blurRadius;
        return this;
    }
    
    public CircleImageView setCornerType(CornerType cornerType) {
        this.cornerType = cornerType;
        return this;
    }
    
    public CircleImageView setOval(boolean oval) {
        isOval = oval;
        return this;
    }
    
    public CircleImageView setOtherType(OtherType otherType) {
